    ...
    return (
        <ScrollView>
            ...
            < ImageBackground
                ...
                style={styles.top} >
                <LinearGradient
                    colors={['transparent', 'rgba(0,0,0,0.2)', 'rgba(0,0,0,0.9)', 'black']}
                    ...
                    <View style={{ paddingHorizontal: spacing.w45 }}>
                        ...
                        <TouchableOpacity onPress={forgot} style={{ marginTop: 5 }}>
                            <Text style={{ color: 'white', fontSize: font.s12, alignSelf: 'flex-end' }}>Forgot Password</Text>
                        </TouchableOpacity>
                        <View style={styles.social}>
                            <View style={styles.line}></View>
                            <Text style={{ fontSize: font.s14, color: color.white }}>Social Logins</Text>
                            <View style={styles.line}></View>
                        </View>
                        ...
                        <TouchableOpacity onPress={register} style={{ marginTop: 8 }}>
                            <Text style={{ color: 'white', fontSize: font.s14, alignSelf: 'center' }}>REGISTER</Text>
                        </TouchableOpacity>
                    </View>
                </LinearGradient>
            </ImageBackground>
