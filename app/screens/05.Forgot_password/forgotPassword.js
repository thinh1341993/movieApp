...
const forgotPassword = () => {
    ...
    return (
        <ScrollView style={{ backgroundColor: color.black }}>
            ...
            <Text style={[styles.title, { color: 'white', fontWeight: 'bold', marginBottom: spacing.h13 }]}>FORGOT PASSWORD?</Text>
            <View style={styles.input}>
                <Text style={[styles.title, { color: color.textGray, marginBottom: spacing.h33 }]}>Enter the email address you used to
